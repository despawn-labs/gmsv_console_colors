...
public:
  ...
  // the stack Pops the value off of the top of the stack
  ...
  // the stack If this function errors, any local C values will not have their
  // destructors called!
...
public:
  ...
  // if it is not NULL If the value at iStackPos is a number, it will be
  // converted in to a string Returns NULL upon failure
